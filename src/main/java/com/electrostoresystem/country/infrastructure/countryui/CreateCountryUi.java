...
public class CreateCountryUi extends JFrame {
    ...
    public CreateCountryUi(CreateCountryUseCase createCountryUseCase, CountryUiController countryUiController) { 
    ...
    private void initComponents() {
        ...
        addComponent(new JLabel("Country name:"), 1, 0);
    ...
    private void saveCountry() {
        try {
            ...
            country.setName(jTextField1.getText());
