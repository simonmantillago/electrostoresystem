...
INSERT INTO sale_status (name) VALUES ('Refund'), ('Completed');
...
VALUES (1, 1, 50, 40.00),  -- Precio menor que 45.00
       (2, 2, 100, 25.00),  -- Precio menor que 28.00
       (3, 3, 75, 50.00);   -- Precio menor que 55.00
